...
public:
	...
	const AIOpenGLComputeShader& GetConvolution3x3();
	const AIOpenGLComputeShader& GetConvolution4x4();
...
private:
	...
	AIOpenGLComputeShader convolution3x3;
	AIOpenGLComputeShader convolution4x4;
